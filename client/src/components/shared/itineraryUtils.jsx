...
export const Icons = {
  ...
  GripLines: () => <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><line x1="3" y1="9" x2="21" y2="9"/><line x1="3" y1="15" x2="21" y2="15"/></svg>,
...
export function stopDays(arrival, departure) {
  const diff = Math.ceil((new Date(departure) - new Date(arrival)) / (1000 * 60 * 60 * 24))
...
export function statusColor(status) {
  ...
  }[status] || { bg: 'rgba(255,255,255,0.06)', color: 'var(--text-muted)', border: 'var(--border-subtle)' }
}
